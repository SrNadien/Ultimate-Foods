 ...
 * - Irrompible
 * - TODAS las funciones vanilla (heredadas de ShovelItem)
 */
public class NadieniteShovelItem extends ShovelItem {
    
    public NadieniteShovelItem(Tier tier, Properties properties) {
