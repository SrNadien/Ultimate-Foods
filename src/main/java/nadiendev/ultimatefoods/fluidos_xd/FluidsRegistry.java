package nadiendev.ultimatefoods.fluidos_xd;
...
public class FluidsRegistry {
                ...
                public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                    consumer.accept(new IClientFluidTypeExtensions() {
                        ...
                        public int getTintColor() {
                            return 0xFFFFFFFF; // sin tint, usa el color real de la textura
                        }
                    });
                }
            });
    ...
    private static BaseFlowingFluid.Properties nadieniteProperties() {
        ...
        .bucket(() -> nadiendev.ultimatefoods.items.ItemsAdds.NADIENITE_FLUID_BUCKET.get())
